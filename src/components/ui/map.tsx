...
function ControlGroup({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex flex-col overflow-hidden rounded-xl border border-zinc-200 bg-white shadow-xl dark:border-zinc-800 dark:bg-zinc-900 [&>button:not(:last-child)]:border-b [&>button:not(:last-child)]:border-zinc-200 dark:[&>button:not(:last-child)]:border-zinc-800">
      {children}
    </div>
  );
}
...
function ControlButton({
  ...
  return (
    <button
      ...
      type="button"
      className={cn(
        "flex size-9 items-center justify-center transition-all text-zinc-600 dark:text-zinc-400",
        "first:rounded-t-xl last:rounded-b-xl",
        "hover:bg-zinc-100 dark:hover:bg-zinc-800 hover:text-zinc-900 dark:hover:text-zinc-100",
        "focus-visible:ring-zinc-500 focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-inset",
...
function MapPopup({
  ...
  return createPortal(
    <div
      className={cn(
        "bg-white dark:bg-zinc-900 text-zinc-900 dark:text-zinc-100 relative max-w-[280px] rounded-2xl border border-zinc-200 dark:border-zinc-800 p-4 shadow-2xl",
        "animate-in fade-in-0 zoom-in-95 duration-200 ease-out",
        className,
      )}
    >
